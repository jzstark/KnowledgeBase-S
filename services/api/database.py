...
ALTER TABLE IF EXISTS entity_candidates ADD COLUMN IF NOT EXISTS aliases TEXT[] DEFAULT '{}';
ALTER TABLE IF EXISTS entity_candidates ADD COLUMN IF NOT EXISTS embedding vector(1536);
...
ALTER TABLE IF EXISTS entity_candidates ADD COLUMN IF NOT EXISTS promoted_entity_id VARCHAR;
ALTER TABLE IF EXISTS entity_candidates ADD COLUMN IF NOT EXISTS updated_at TIMESTAMPTZ DEFAULT NOW();
