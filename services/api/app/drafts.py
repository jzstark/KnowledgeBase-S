...
MAX_KNOWLEDGE_CHARS = settings.retrieval.draft_knowledge_chars
...
async def generate_draft(body: GenerateRequest):
    ...
    for node in retrieval["articles"]:
        if remaining <= settings.drafts.min_remaining_chars:
            break
    ...
    message = claude.messages.create(
        model=settings.models.draft_generation,
        max_tokens=settings.llm_output_tokens.draft_generation,
